...
class ProgressBar extends StatefulWidget {
  ...
  final Color color;
  ProgressBar(this.data, this.color, {required this.controller});
  @override
  State<StatefulWidget> createState() => ProgressBarState();
}

class ProgressBarState extends State<ProgressBar> {
  late Animation<int> _saledCountAnimation;
  late Animation<int> _progessAnimation;
  late Animation<int> _barProgerssAnimation;
  @override
