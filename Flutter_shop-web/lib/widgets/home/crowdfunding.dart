...
class LittleCrowdFundingWidget extends StatelessWidget {
  final CrowdFundItemModel data;
  final AnimationController controller;
  LittleCrowdFundingWidget(this.data, {required this.controller});
  @override
  Widget build(BuildContext context) {
...
class CrowdFundingFloor extends StatelessWidget {
  ...
  final AnimationController controller;
  CrowdFundingFloor({Key? key, required this.data, required this.controller}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    double deviceWidth = MediaQuery.of(context).size.width;
  ...
  Widget _build(double deviceWidth) {
    ...
    return Column(children: <Widget>[
      BigCrowdFundingWidget(items[0],controller),
      Row(
        children: <Widget>[
          Expanded(
