...
class FisrtTabWidgetState extends State<FisrtTabWidget>
  ...
  final GlobalKey<State> crowdFundingFloorKey =  GlobalKey();
 ...
 late AnimationController controller;
  ...
  bool _onScroll(ScrollNotification scroll) {
    if (scroll.depth == 0) {
      ...
      RenderObject? boxrender =  currentContext.findRenderObject();
      RenderObject? listBoxRender = scroll.context?.findRenderObject() ;

      if (boxrender == null) return false;
      if (listBoxRender == null) return false;

      RenderBox box =  boxrender as RenderBox;
      RenderBox listBox = listBoxRender  as RenderBox ;
